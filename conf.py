...
BLOG_AUTHOR = "Null"  # (translatable)
BLOG_TITLE = "Null"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://dontaskmewhoami.life/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://dontaskmewhoami.life/"
BLOG_EMAIL = "null@dontaskmewhoami.life"
BLOG_DESCRIPTION = "肥宅的自言自語"  # (translatable)
...
LATEX_FORMULA_OUTPUT_FORMAT = 'svg'
